...
type WebHeaders struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	WebHeaders map[string]string `protobuf:"bytes,1,rep,name=web_headers,json=webHeaders,proto3" json:"web_headers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *WebHeaders) Reset() {
	*x = WebHeaders{}
...
func (x *WebHeaders) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebHeaders) ProtoMessage() {}

func (x *WebHeaders) ProtoReflect() protoreflect.Message {
	mi := &file_authentication_proto_msgTypes[0]
...
// Deprecated: Use WebHeaders.ProtoReflect.Descriptor instead.
func (*WebHeaders) Descriptor() ([]byte, []int) {
	return file_authentication_proto_rawDescGZIP(), []int{0}
}

func (x *WebHeaders) GetWebHeaders() map[string]string {
	if x != nil {
		return x.WebHeaders
	}
	return nil
...
var file_authentication_proto_rawDesc = []byte{
	...
	,
...
var file_authentication_proto_goTypes = []interface{}{
	(*WebHeaders)(nil), // 0: WebHeaders
	nil,                // 1: WebHeaders.WebHeadersEntry
}
var file_authentication_proto_depIdxs = []int32{
	1, // 0: WebHeaders.web_headers:type_name -> WebHeaders.WebHeadersEntry
